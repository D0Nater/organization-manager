...
from orgmgr.lib.specification.field import IsNotNoneSpecification
...
def wrap_field(field_info: Any) -> Any:
    ...
    Examples:
        ...
        >>> from orgmgr.lib.schemas.fields import wrap_field
        >>>
    ...
    class WrappedField(field_info.__class__):  # type: ignore
        ...
        def _get_kwargs(self) -> dict[str, Any]:
            ...
            Returns:
                dict[str, Any]: The keyword arguments of the field.
            """
        ...
        def __call__(self, **new_kwargs: Any) -> Any:
            ...
            Returns:
                Any: A new field with updated metadata.
            """
        ...
        def to_class(self, _class: Any, **new_kwargs: Any) -> Any:
            ...
            Returns:
                Any: A new instance of the class. The field is initialized with the metadata from the wrapped field.
            """
            kwargs = self._get_kwargs()
            kwargs.update(new_kwargs)
...
DELETED_INCLUSION_FILTER = BaseField(
    ...
    default=None,
    specification=IsNotNoneSpecification("deleted_at"),
)
