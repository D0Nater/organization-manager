...
from orgmgr.version import __version__ as release
...
def configure_sentry(
    ...
    Args:
        ...
        fastapi_integration (bool, optional): Enable FastAPI integration. Defaults to True.
    """
    ...
    if fastapi_integration:
        ...
        before_send = _before_send_fastapi
...
def _before_send_fastapi(event: "Event", _hint: "Hint") -> "Event":
    """Before send hook for FastAPI.
